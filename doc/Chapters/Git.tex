...
Now, from GitHub web page \texttt{create the pull request} and \texttt{merge} accepted changes
...
\section{Merging and resolving conflicts from VS}
 ...
 Select \texttt{Git/Manage branches} and from the master branch (it has to be active),  merge  
 ...
 \item Select Git/Manage branches. 
...
\end{enumerate}
If changes are not still committed, select \texttt{Git changes} and a list of files that 
