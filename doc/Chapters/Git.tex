...
\
 ...
 First of all, a GitHub account must be created to store our remote repositories. 
 Go to \texttt{github.com/join} and create a GitHub account associated to our email. 
 \begin{enumerate}
 ...
 and \texttt{readme} to start with. 
...
\section{Create a local repository}

 \begin{enumerate}
 \item {\bf  Clone a local repository from  GitHub.}
 \item {\bf Create a local repository from Visual Studio. } 
 \item {\bf Create a local repository from GitHub Desktop. } 
...
\section{How to work with collaborators} 
First of all, add collaborators to work with. 
If you are owner of the repository, from your gitHub account,  
go to \texttt{settings/manage access} to invite others to  collaborate in your project. 
...
\section{How to work with the open source communityother persons} 
\begin{enumerate}
    \item Collaborators
    \item 
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Work on that branch, make commits, push those commits to store everything in GitHub and create issues to ask for help to your collaborators. 
